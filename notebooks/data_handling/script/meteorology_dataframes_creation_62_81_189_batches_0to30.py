...
# handler.create_yearly_dataframes_parallel_batches(base_filename,years=years,add_year_to_name=True,njobs=1,
#                                                   batch_size=30)
...
# Encoutered a file format error. Bug fixed...
...
handler.create_yearly_dataframes_parallel_batches(base_filename,years=years,add_year_to_name=True,njobs=11,
                                                  batch_size=30,num_batch_start=0,num_batch_end=30)
