...
meteo_handler = MeteorologyToPandasHandler(debug=True, keep_na=True)
...
# import torch
# df = torch.load("../../data/meteorology_dataframes_23_81_169_keep_na/meteorology_dataframe_23_81_169_keep_na_2003.pkl")
