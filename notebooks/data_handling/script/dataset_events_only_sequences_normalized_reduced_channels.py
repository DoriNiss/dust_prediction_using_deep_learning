...
t_events_only = inputs[targets[:,0]>=event_threshold]
t_events_only.shape
...
for i in tqdm(range(num_sequences)):
    ...
    save_as_str = f"{data_dir}/{base_filename}_events_sequences_normalized_reduced_{save_as_strs[i]}_"
    ...
    inputs_events = seq_handler.get_batched_sequences_from_original_idxs(inputs,original_events_idxs)
