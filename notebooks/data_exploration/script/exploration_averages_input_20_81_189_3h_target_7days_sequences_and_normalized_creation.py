...
description_reduced_channels["input"] = {
    0: {"short": "avg Z","long":"Averaged Geopotential Height","channels":"SLP,Z@850,500,250"},
    1: {"short": "avg U","long":"Averaged Northward Wind (U)","channels":"U@850,500,250,u10m"},
    2: {"short": "avg V","long":"Averaged Eastward Wind (V)","channels":"V@850,500,250,v10m"},
    3: {"short": "avg PV","long":"Averaged Potential Vorticity (PV)","channels":"PV@325,330,335,340"},
    4: {"short": "avg AOD","long":"Averaged AOD","channels":"aod550,duaod550,aermssdul,aermssdum"},
}
